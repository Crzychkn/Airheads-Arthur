...
<form method="post" action="checkoutProcess.php" type="submit" name="submit" role="form" class="" id="customerinfo">
        ...
        <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" name="email" class="form-control form-control-large" id="email" placeholder="Enter email">
                    </div>
                    <div class="form-group">
        ...
        <div class="list-group-item">
          <div class="list-group-item-heading">          
              <div class="row radio">
               ...
               <dl class="dl-small">
                        <dt>Owner Name</dt>
                        <dd><input type="textbox" name="owner" class="form-control form-control-small" id="CreditCardOwner" required="true"></dd>
                      </dl>
                      </div>
                <div class="col-xs-5">
                      <dl class="dl-small">
                        <dt>Credit Card Number</dt>
                        <dd><input type="number" name="cc" class="form-control form-control-small" id="CreditCardNumber" required="true"></dd>
                      </dl>
          </div>
                    <div class="col-xs-3">
                      <dl class="dl-small">
