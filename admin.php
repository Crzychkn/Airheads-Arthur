    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="store.html">STORE</a></li>
         <li><a href="cart.html">CART</a></li> <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">
                            ...
                            <div class="container-fluid">
                                <form class="">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <a href="index.html" type="submit" id="btnLogin" class="btn btn-success btn-sm">Logout</a>
                                </form>
                            </div>
                        </div>
                    </div>
